...
setblock 9 104 17 minecraft:redstone_lamp[lit=true]
...
execute in minecraft:overworld at @e[type=marker,tag=tardis_location] run clone from tardisim:tardis 1 1 1 5 7 5 ~-2 ~-1 ~-2 replace move
