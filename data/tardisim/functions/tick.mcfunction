...
execute as @a at @s if entity @e[type=marker,tag=tardis_location,distance=..1] if score $demat tardis matches 0 in tardisim:tardis run function tardisim:enter_tardis
